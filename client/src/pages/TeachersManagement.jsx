    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center py-3 sm:py-4 gap-3 sm:gap-0">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div>
                <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 dark:text-white">Teachers Management</h1>
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hidden sm:block">Manage teacher profiles, subjects, and availability for timetable generation</p>
              </div>
            </div>
            <div className="flex items-center space-x-2 sm:space-x-4 w-full sm:w-auto justify-between sm:justify-end">
              <ThemeToggle />
              <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hidden md:inline">Welcome, {user?.name}</span>
              <button
                onClick={logout}
                className="text-xs sm:text-sm text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 px-2 py-1"
              >
                Logout
              </button>
            </div>
      ...
      <div className="w-full flex pt-0">
        ...
        <main className="flex-1">
          <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8" style={{ maxHeight: 'calc(100vh - 4rem)', overflow: 'auto' }}>
            ...
            {/* Action Buttons */}
            <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3 sm:gap-0 mb-4 sm:mb-6 md:mb-8">
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
                <button
                  ...
                  className="flex items-center justify-center px-3 sm:px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 text-sm"
                >
              ...
              <button
                ...
                className="flex items-center justify-center px-4 sm:px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm"
              >
            ...
            {/* Search and Filters */}
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-3 sm:p-4 md:p-6 mb-4 sm:mb-6 md:mb-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
              <div className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 border-b border-gray-200 dark:border-gray-700">
                <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">Teachers List</h2>
              </div>
                    ...
                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                      {(teachers || []).map((teacher) => (
                        <tr key={teacher._id || teacher.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${teacher.priority === 'high' ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' :
                    ...
                    <div>
                      ...
                      <div className="flex space-x-2">
                        <input
                          ...
                          className={`flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 text-gray-900 dark:text-white ${modalType === 'add'
