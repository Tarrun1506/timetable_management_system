  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
      <div className={`rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto ${isDarkMode ? 'bg-gray-800' : 'bg-white'
        ...
        {/* Success Message */}
        {success && (
          <div className="m-4 sm:m-6 p-3 sm:p-4 bg-green-100 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg flex items-start sm:items-center gap-2 sm:gap-3">
            <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-green-600 flex-shrink-0" />
            <div>
              <p className="font-medium text-green-800 dark:text-green-300 text-sm sm:text-base">Query Submitted Successfully!</p>
        ...
        {/* Error Message */}
        {error && (
          <div className="m-4 sm:m-6 p-3 sm:p-4 bg-red-100 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg flex items-start sm:items-center gap-2 sm:gap-3">
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-3 sm:space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className={`w-full px-3 sm:px-4 py-2 rounded-lg border text-sm sm:text-base ${isDarkMode
          ...
          {/* Info Box */}
          <div className={`p-3 sm:p-4 rounded-lg border ${isDarkMode
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 pt-2 sm:pt-4">
            <button
              ...
              className="flex-1 px-4 py-2.5 sm:py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2 font-medium transition-colors text-sm sm:text-base"
            >
              {submitting ? (
                <>
            ...
            <button
              ...
              onClick={onClose}
              disabled={submitting}
              className={`px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-medium transition-colors text-sm sm:text-base ${isDarkMode
