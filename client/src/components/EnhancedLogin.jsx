      ...
      <div className="max-w-md w-full space-y-6 sm:space-y-8">
        ...
        <form className="mt-6 sm:mt-8 space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-3 sm:space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="mt-1 appearance-none rounded-md relative block w-full px-3 py-2 sm:py-2.5 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 text-sm sm:text-base"
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  onChange={handleInputChange}
                  required
                  className="appearance-none rounded-md relative block w-full px-3 py-2 sm:py-2.5 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 text-sm sm:text-base"
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-md p-3 sm:p-4">
            <h4 className="text-xs sm:text-sm font-medium text-gray-800 mb-2">First time logging in?</h4>
